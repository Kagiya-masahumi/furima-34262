class OrderAddress
  ...
  attr_accessor :item_id, :user_id, :postal_num, :prefecture, :city, :address, :building, :phone_num
  ...
  def save
    ...
    Address.create(postal_num: postal_num, prefecture: prefecture,  city: city,  address: address, 
